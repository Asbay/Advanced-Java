...
public class ThreadPool {
    ...
    public static void main(String[] args) {
        ...
        // 10 adet thread olusturmak icin önce bunlari yaziyoruz variable olarak. henuz start yapmadigimiz icin olusmuyor
        ...
        //start yaparsam hepsi olusur ve is yapmaya baslar ama  basta söyledik sadece 2 thread havuzda olacak
      /*  thread1.start();
        thread2.start();
        thread3.start();
        thread4.start();
        ...
        thread8.start();
        thread9.start();
        thread10.start(); // start deyince run i calistirir run bitince thread son bulur
*/       //bu sekilde yapinca havuzda 2 thread olmasi gerektigi icin sadece 2 thread oluscak ve isleri bitince digerlerinin isini yapmaya gececekler
        ...
        service.shutdown(); //thread havuzundaki threadler  beklemeye devam etmesin diye shutdown ile havuzu kapatiyoruz
    }
}
